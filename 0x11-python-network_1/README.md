Python - Network #1
---------------------------------------------------------------------
In this project we learn how to use the urllib and requests Python libraries to send and receive HTTP messages to URL's. we practiced sending GET and POST requests, fetching JSON resources, and interacting with API's.
--------------------------------------------------------------------
Tasks:
